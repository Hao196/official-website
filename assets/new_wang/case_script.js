    ...
    */
    ...
    PPTBox.prototype =
    {
        _createMainBox : function (){
            ...
            html += "</div>";
			html += "<div id='"+this.uid+"_imagebox' class='imagebox' ></div>";
            document.write(html);
        },
        _init : function (){
            var picstyle= "";
            ...
            for(var i=0;i<this._box.length;i++){
                ...
                imageHTML ="<div class='bitdiv "+((i==0)?"curimg":"defimg")+"' title ="+parame.title+"  "+picstyle+" onclick = \""+eventstr+".mouseoverPic("+i+")\"  onmouseover=\""+eventstr+".mouseoverPic("+i+")\">●</div>" + imageHTML;
            }
        ...
        changeIndex : function(idx){
            ...
            moveElement(this.uid+"_flashbox",-(idx*this.width),30);
